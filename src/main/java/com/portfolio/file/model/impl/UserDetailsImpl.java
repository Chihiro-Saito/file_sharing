...
public class UserDetailsImpl  implements UserDetails {
	...
	/**
	 * ユーザーアカウントが有効期限内か確認するフラグを取得する.
	 * ユーザー情報が有効な場合は、有効期限内とする.
	 *
	...
	/**
	 * ユーザーアカウントがロックされているか確認するフラグを取得する.
	 * ユーザー情報が無効な場合は、ロックされたとする.
	 *
	 *  @return アカウントロックフラグ
	 */
    @Override
    ...
    @Override
	/**
	 * パスワードの有効期限内か確認するフラグを取得する.
	 * ユーザー情報が無効な場合は、パスワードの有効期限外とする.
	 *
